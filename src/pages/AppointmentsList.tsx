...
const AppointmentsList = () => {
  ...
  const openReportPreview = (base64String) => {
    ...
    if (!base64String.startsWith('data:')) {
      // Default to PDF if not specified, as it's standard for medical reports
    ...
    <div className="min-h-screen bg-slate-50 p-6 font-sans relative">
      <div className="max-w-4xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-white p-8 rounded-xl border border-dashed text-center text-slate-500">No appointments found.</div>
        ) : (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-3">
                        <h3 className="font-bold text-slate-800 text-lg">{appt.patient_symptoms}</h3>
      ...
      {selectedReport && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="bg-white w-full max-w-4xl h-[85vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            {/* Download Link Footer (Optional fallback) */}
